...
type SrvrDataMovementRecord struct {
	...
	mockDM *nnfv1alpha9.NnfDataMovement
}
...
func (r *DriverRequest) CreateMock(ctx context.Context, dmreq DMRequest) (string, *nnfv1alpha9.NnfDataMovement, error) {
	...
	dm := &nnfv1alpha9.NnfDataMovement{
		ObjectMeta: metav1.ObjectMeta{
			...
			Labels: map[string]string{
				nnfv1alpha9.DataMovementInitiatorLabel: dmreq.ComputeName,
			},
		},
	...
	r.dmProfile = &nnfv1alpha9.NnfDataMovementProfile{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "mock",
...
func (r *DriverRequest) dmKey(dm *nnfv1alpha9.NnfDataMovement) string {
...
func (r *DriverRequest) recordRequest(ctx context.Context, dm *nnfv1alpha9.NnfDataMovement) {
	drvr := r.Drvr
...
func (r *DriverRequest) loadRequest(dm *nnfv1alpha9.NnfDataMovement) (SrvrDataMovementRecord, error) {
...
func (r *DriverRequest) deleteRequest(dm *nnfv1alpha9.NnfDataMovement) {
...
func (r *DriverRequest) buildStatusResponse(statreq StatusRequest, dm *nnfv1alpha9.NnfDataMovement) (*DataMovementStatusResponse_v1_0, int, error) {

	if dm.Status.StartTime.IsZero() && dm.Status.Status != nnfv1alpha9.DataMovementConditionReasonInvalid {
	...
	stateMap := map[string]DataMovementStatusResponse_State{
		...
		nnfv1alpha9.DataMovementConditionTypeStarting: DataMovementStatusResponse_STARTING,
		nnfv1alpha9.DataMovementConditionTypeRunning:  DataMovementStatusResponse_RUNNING,
		nnfv1alpha9.DataMovementConditionTypeFinished: DataMovementStatusResponse_COMPLETED,
	}
	...
	statusMap := map[string]DataMovementStatusResponse_Status{
		...
		nnfv1alpha9.DataMovementConditionReasonFailed:    DataMovementStatusResponse_FAILED,
		nnfv1alpha9.DataMovementConditionReasonSuccess:   DataMovementStatusResponse_SUCCESS,
		nnfv1alpha9.DataMovementConditionReasonInvalid:   DataMovementStatusResponse_INVALID,
		nnfv1alpha9.DataMovementConditionReasonCancelled: DataMovementStatusResponse_CANCELLED,
	}
...
func (r *DriverRequest) driveWithContext(ctx context.Context, ctxCancel context.Context, dm *nnfv1alpha9.NnfDataMovement, crLog logr.Logger) error {
	drvr := r.Drvr
	...
	cmdStatus := nnfv1alpha9.NnfDataMovementCommandStatus{}
	cmdStatus.Command = cmd.String()

	setStart := func() {
		now := metav1.NowMicro()
		dm.Status.StartTime = &now
		dm.Status.State = nnfv1alpha9.DataMovementConditionTypeRunning
...
func (r *DriverRequest) runit(ctx context.Context, ctxCancel context.Context, contextDelete func(), dmReq types.NamespacedName, cmd *exec.Cmd, cmdStatus *nnfv1alpha9.NnfDataMovementCommandStatus, profile *nnfv1alpha9.NnfDataMovementProfile, mpiHostfile string, log logr.Logger) {
	drvr := r.Drvr
	...
	go func() {
				...
				parseAndUpdateProgress := func() {
					...
					if !drvr.Mock {
						err = retry.RetryOnConflict(retry.DefaultRetry, func() error {
							...
							if dm.Status.CommandStatus == nil {
								dm.Status.CommandStatus = &nnfv1alpha9.NnfDataMovementCommandStatus{}
							}
		...
		if errors.Is(ctxCancel.Err(), context.Canceled) {
			...
			dm.Status.Status = nnfv1alpha9.DataMovementConditionReasonCancelled
		} else if err != nil {
...
func (r *DriverRequest) notifyCompletion(dm *nnfv1alpha9.NnfDataMovement) {
	drvr := r.Drvr
	key := r.dmKey(dm)
...
func setUserConfig(dmreq DMRequest, dm *nnfv1alpha9.NnfDataMovement) {
	dm.Spec.UserConfig = &nnfv1alpha9.NnfDataMovementConfig{}
...
func (r *DriverRequest) createNnfDataMovement(ctx context.Context, dmreq DMRequest, computeMountInfo *dwsv1alpha7.ClientMountInfo, computeClientMount *dwsv1alpha7.ClientMount) (*nnfv1alpha9.NnfDataMovement, error) {
	...
	dm := &nnfv1alpha9.NnfDataMovement{
		ObjectMeta: metav1.ObjectMeta{
			...
			Labels: map[string]string{
				nnfv1alpha9.DataMovementInitiatorLabel: dmreq.ComputeName,
				nnfv1alpha9.DirectiveIndexLabel:        dwIndex,
			},
		},
		Spec: nnfv1alpha9.NnfDataMovementSpec{
			Source: &nnfv1alpha9.NnfDataMovementSpecSourceDestination{
...
func getDirectiveIndexFromClientMount(object *dwsv1alpha7.ClientMount) (string, error) {
	...
	dwIndex, found := labels[nnfv1alpha9.DirectiveIndexLabel]
	if !found {
...
func (r *DriverRequest) createNnfNodeDataMovement(ctx context.Context, dmreq DMRequest, computeMountInfo *dwsv1alpha7.ClientMountInfo) (*nnfv1alpha9.NnfDataMovement, error) {
...
func (r *DriverRequest) selectProfile(ctx context.Context, dmreq DMRequest) (*nnfv1alpha9.NnfDataMovementProfile, error) {
	drvr := r.Drvr
