...
func CreateDefaultServer(opts *ServerOptions) (*defaultServer, error) {
	...
	if len(opts.nodeName) == 0 {
		...
		storageNode := func() *dwsv1alpha4.SystemConfigurationStorageNode {
...
func (s *defaultServer) Create(ctx context.Context, req *pb.DataMovementCreateRequest) (*pb.DataMovementCreateResponse, error) {
	...
	workflow := &dwsv1alpha4.Workflow{ObjectMeta: metav1.ObjectMeta{
	...
	if workflow.Status.State != dwsv1alpha4.StatePreRun || workflow.Status.Status != "Completed" {
		return &pb.DataMovementCreateResponse{
			Status:  pb.DataMovementCreateResponse_FAILED,
			Message: fmt.Sprintf("Workflow must be in '%s' state and 'Completed' status", dwsv1alpha4.StatePreRun),
		}, nil
	}
...
func getDirectiveIndexFromClientMount(object *dwsv1alpha4.ClientMount) (string, error) {
...
func (s *defaultServer) createNnfDataMovement(ctx context.Context, req *pb.DataMovementCreateRequest, computeMountInfo *dwsv1alpha4.ClientMountInfo, computeClientMount *dwsv1alpha4.ClientMount) (*nnfv1alpha7.NnfDataMovement, error) {
...
func (s *defaultServer) createNnfNodeDataMovement(ctx context.Context, req *pb.DataMovementCreateRequest, computeMountInfo *dwsv1alpha4.ClientMountInfo) (*nnfv1alpha7.NnfDataMovement, error) {
	// Find the ClientMount for the rabbit.
	source, err := s.findRabbitRelativeSource(ctx, computeMountInfo, req)
	if err != nil {
		return nil, err
...
func (s *defaultServer) List(ctx context.Context, req *pb.DataMovementListRequest) (*pb.DataMovementListResponse, error) {
	...
	opts := []client.ListOption{
		client.MatchingLabels(map[string]string{
			dwsv1alpha4.OwnerNameLabel:      req.Workflow.Name,
			dwsv1alpha4.OwnerNamespaceLabel: req.Workflow.Namespace,
		}),
	}
...
func (s *defaultServer) findRabbitRelativeSource(ctx context.Context, computeMountInfo *dwsv1alpha4.ClientMountInfo, req *pb.DataMovementCreateRequest) (string, error) {
	...
	listOptions := []client.ListOption{
		...
		client.MatchingLabels(map[string]string{
			dwsv1alpha4.WorkflowNameLabel:      req.Workflow.Name,
			dwsv1alpha4.WorkflowNamespaceLabel: req.Workflow.Namespace,
		}),
	}

	clientMounts := &dwsv1alpha4.ClientMountList{}
...
func (s *defaultServer) findComputeMountInfo(ctx context.Context, req *pb.DataMovementCreateRequest) (*dwsv1alpha4.ClientMount, *dwsv1alpha4.ClientMountInfo, error) {
