...
func CreateDefaultServer(opts *ServerOptions) (*defaultServer, error) {
	...
	if len(opts.nodeName) == 0 {
		...
		storageNode := func() *dwsv1alpha2.SystemConfigurationStorageNode {
...
func (s *defaultServer) setupWithManager(mgr ctrl.Manager) error {
	...
	p := predicate.Funcs{
		...
		UpdateFunc: func(ue event.UpdateEvent) bool {
			if initiator := ue.ObjectNew.GetLabels()[nnfv1alpha5.DataMovementInitiatorLabel]; initiator == s.name {
				return true
			}
			return false
		},
	...
	err := ctrl.NewControllerManagedBy(mgr).
		For(&nnfv1alpha5.NnfDataMovement{}, builder.WithPredicates(p)).
...
func setUserConfig(req *pb.DataMovementCreateRequest, dm *nnfv1alpha5.NnfDataMovement) {
...
func (s *defaultServer) getProfile(ctx context.Context, profileName string) (*nnfv1alpha5.NnfDataMovementProfile, error) {
	ns := "nnf-system"
...
func (s *defaultServer) createNnfDataMovement(ctx context.Context, req *pb.DataMovementCreateRequest, computeMountInfo *dwsv1alpha2.ClientMountInfo, computeClientMount *dwsv1alpha2.ClientMount) (*nnfv1alpha5.NnfDataMovement, error) {
	...
	dm := &nnfv1alpha5.NnfDataMovement{
		ObjectMeta: metav1.ObjectMeta{
			...
			Labels: map[string]string{
				nnfv1alpha5.DataMovementInitiatorLabel: s.name,
...
func (s *defaultServer) createNnfNodeDataMovement(ctx context.Context, req *pb.DataMovementCreateRequest, computeMountInfo *dwsv1alpha2.ClientMountInfo) (*nnfv1alpha5.NnfDataMovement, error) {
	// Find the ClientMount for the rabbit.
	source, err := s.findRabbitRelativeSource(ctx, computeMountInfo, req)
	if err != nil {
		return nil, err
...
func (s *defaultServer) List(ctx context.Context, req *pb.DataMovementListRequest) (*pb.DataMovementListResponse, error) {
	...
	opts := []client.ListOption{
		client.MatchingLabels(map[string]string{
			dwsv1alpha2.OwnerNameLabel:      req.Workflow.Name,
			dwsv1alpha2.OwnerNamespaceLabel: req.Workflow.Namespace,
		}),
	}

	list := nnfv1alpha5.NnfDataMovementList{}
...
func (s *defaultServer) Status(ctx context.Context, req *pb.DataMovementStatusRequest) (*pb.DataMovementStatusResponse, error) {
	...
	if dm.Status.StartTime.IsZero() && dm.Status.Status != nnfv1alpha5.DataMovementConditionReasonInvalid {
		return &pb.DataMovementStatusResponse{
	...
	stateMap := map[string]pb.DataMovementStatusResponse_State{
		...
		nnfv1alpha5.DataMovementConditionTypeStarting: pb.DataMovementStatusResponse_STARTING,
		nnfv1alpha5.DataMovementConditionTypeRunning:  pb.DataMovementStatusResponse_RUNNING,
		nnfv1alpha5.DataMovementConditionTypeFinished: pb.DataMovementStatusResponse_COMPLETED,
	}
	...
	statusMap := map[string]pb.DataMovementStatusResponse_Status{
		...
		nnfv1alpha5.DataMovementConditionReasonFailed:    pb.DataMovementStatusResponse_FAILED,
		nnfv1alpha5.DataMovementConditionReasonSuccess:   pb.DataMovementStatusResponse_SUCCESS,
		nnfv1alpha5.DataMovementConditionReasonInvalid:   pb.DataMovementStatusResponse_INVALID,
		nnfv1alpha5.DataMovementConditionReasonCancelled: pb.DataMovementStatusResponse_CANCELLED,
	}
...
func (s *defaultServer) findRabbitRelativeSource(ctx context.Context, computeMountInfo *dwsv1alpha2.ClientMountInfo, req *pb.DataMovementCreateRequest) (string, error) {
	...
	listOptions := []client.ListOption{
		...
		client.MatchingLabels(map[string]string{
			dwsv1alpha2.WorkflowNameLabel:      req.Workflow.Name,
			dwsv1alpha2.WorkflowNamespaceLabel: req.Workflow.Namespace,
		}),
	}
...
func (s *defaultServer) findComputeMountInfo(ctx context.Context, req *pb.DataMovementCreateRequest) (*dwsv1alpha2.ClientMount, *dwsv1alpha2.ClientMountInfo, error) {
...
func (s *defaultServer) getNamespace(uid string) string {
	...
	return nnfv1alpha5.DataMovementNamespace
}
