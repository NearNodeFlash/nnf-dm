...
func GetDMProfile(clnt client.Client, ctx context.Context, dm *nnfv1alpha3.NnfDataMovement) (*nnfv1alpha3.NnfDataMovementProfile, error) {
...
func PrepareDestination(clnt client.Client, ctx context.Context, profile *nnfv1alpha3.NnfDataMovementProfile, dm *nnfv1alpha3.NnfDataMovement, mpiHostfile string, log logr.Logger) error {
...
func checkIndexMountDir(clnt client.Client, ctx context.Context, dm *nnfv1alpha3.NnfDataMovement) (string, error) {
...
func GetStorageNodeNames(clnt client.Client, ctx context.Context, dm *nnfv1alpha3.NnfDataMovement) ([]string, error) {
