...
ARTI_URL_MASTER=https://arti.dev.cray.com/artifactory/rabsw-docker-master-local/cray-dp-nnf-dm/
ARTI_URL_DEV=https://arti.dev.cray.com/ui/native/rabsw-docker-unstable-local/cray-dp-nnf-dm/
...
if [[ "$CURRENT_BRANCH_NAME" == "master" ]] || [[ "$CURRENT_BRANCH_NAME" == "HEAD" ]]; then
    ...
    IMAGE_TAG_BASE=arti.dev.cray.com/rabsw-docker-unstable-local/cray-dp-nnf-dm
